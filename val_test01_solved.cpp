...
//
{
  ...
  // delete [] x;   
  // valgrind doesn't like this -- "deleting memory that was not allocated by new is undefined"
  // it is happy with free(x) instead
  // what is the difference between "free(x)" and "delete [] x" ... ?
